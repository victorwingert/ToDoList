...
public class EditProfissional extends javax.swing.JDialog {

    private EditController editController;

    public EditProfissional(java.awt.Frame parent, boolean modal, EditController editController) {
        super(parent, modal);
        this.editController = editController;
        initComponents();
    }

    public EditProfissional(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void setPrioridadeField(String prioridade) {
        this.prioridade.setText(prioridade);
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(prazo, javax.swing.GroupLayout.DEFAULT_SIZE, 327, Short.MAX_VALUE)))))
                .addContainerGap())
        );
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        editController.editProfissional(nome, categoria, prioridade, status, responsavel, prazo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditProfissional.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditProfissional dialog = new EditProfissional(new javax.swing.JFrame(), true);
